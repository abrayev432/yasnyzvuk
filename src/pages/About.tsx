          ...
          <div className="grid gap-16">
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-4">
                  Компания "Ясный звук" была основана в 2020 году молодой командой энтузиастов, объединенных 
                  общей целью - сделать мир звуков доступным для каждого. За короткое время мы заняли прочное 
                  место на рынке слуховых аппаратов в Москве.
                </p>
                <p className="text-lg text-muted-foreground">
                  Несмотря на молодой возраст компании, наша команда обладает богатым опытом в области 
                  аудиологии и слухопротезирования. Мы активно внедряем инновационные подходы и используем 
                  самые современные технологии для помощи нашим клиентам.
                </p>
              </div>
            </motion.div>
