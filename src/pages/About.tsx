          ...
          <div className="grid gap-16">
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-4">
                  Компания "Ясный звук" была основана в 2025 году современной командой профессионалов, 
                  объединенных общей целью - сделать мир звуков доступным для каждого. Мы представляем 
                  новое поколение компаний в сфере слухопротезирования.
                </p>
                <p className="text-lg text-muted-foreground">
                  С самого начала наша команда сосредоточена на применении самых передовых технологий 
                  и инновационных подходов в области аудиологии и слухопротезирования. Мы используем 
                  только самые современные решения для помощи нашим клиентам.
                </p>
              </div>
            </motion.div>
