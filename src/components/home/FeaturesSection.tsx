...
const FeatureCard = memo(({ feature }: { feature: typeof features[0] }) => {
  return (
    <div className="group modern-card modern-hover p-6 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className={`mb-4 inline-flex h-12 w-12 items-center justify-center ${feature.gradient} rounded-xl shadow-lg transition-all duration-300 group-hover:shadow-2xl group-hover:scale-110`}>
...
const FeaturesSection = memo(() => {
  return (
    <section className="bg-gradient-to-br from-white via-slate-50 to-blue-50 py-16 relative overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10 w-24 h-24 bg-gradient-to-br from-brand/20 to-modern-purple/20 rounded-full blur-2xl animate-float" style={{animationDelay: '3s'}}></div>
      
      <div className="container px-4 md:px-6 relative z-10">
        <div className="text-center mb-12 animate-fade-in">
          <div className="inline-flex items-center bg-gradient-to-r from-brand to-modern-purple text-white px-4 py-2 rounded-full text-sm font-medium mb-6 shadow-lg">
