...
const bannerSlides = [
  ...
  },
  {
    ...
    subtitle: "По электронному сертификату",
    description: "Получите слуховые аппараты и средства реабилитации с использованием электронного сертификата МИР",
    buttonText: "Подробнее",
    buttonLink: "/delivery",
    backgroundImage: "/lovable-uploads/ac7fad48-f94d-417f-ae54-abf0ca22b94c.png",
    showRehabCard: true
  }
];
                ...
                <div className="relative h-[200px] md:h-[300px] overflow-hidden mx-4 md:mx-6 my-4 rounded-2xl shadow-lg">
                  ...
                  <div className="relative h-full flex items-center justify-between px-6 md:px-12 z-10">
                    <div className="max-w-xl text-white space-y-3 md:space-y-4">
                      ...
                      {slide.buttonText && (
                        <Button asChild className="tehnika-button-green mt-4">
                          <Link to={slide.buttonLink} className="gap-2">
                            {slide.buttonText}
                    ...
                    {slide.showBatteries && (
                      <div className="hidden md:block">
                        {/* Battery images can be added here */}
                      </div>
                    )}
        ...
        {bannerSlides.map((_, index) => (
          <button
            ...
            className={`h-2 rounded-full transition-all duration-300 ${
              current === index ? 'w-8 bg-brand shadow-lg' : 'w-2 bg-gray-300 hover:bg-gray-400'
            }`}
