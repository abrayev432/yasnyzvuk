...
const HeroSection = memo(() => {
  ...
  return <section className="relative bg-white py-12 md:py-16">
        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
          ...
          <div className="flex items-center justify-center">
            <div className="relative h-[350px] w-full max-w-[450px] rounded-2xl overflow-hidden tehnika-card bg-white">
              {!imageLoaded && <div className="h-full w-full bg-gray-100 animate-pulse flex items-center justify-center">
                  <Volume className="h-16 w-16 text-brand animate-pulse" />
                </div>}
              <img alt="Современные слуховые аппараты" className={`h-full w-full object-contain p-6 transition-all duration-700 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`} src="https://www.sinohearing.com/wp-content/uploads/2019/10/bluetooth-hearing-aid-app-control.jpg" loading="eager" onLoad={() => setImageLoaded(true)} />
              
              {imageLoaded && <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-100">
