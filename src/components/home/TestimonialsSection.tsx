...
const testimonials = [
  {
    ...
    rating: 5,
    image: "/src/assets/images/testimonial-woman-1.jpg",
  },
  {
    name: "Иван Соколов",
    ...
    rating: 5,
    image: "/src/assets/images/testimonial-man-1.jpg",
  },
  {
    name: "Елена Николаева",
    text: "Удобно, что в магазине можно не только купить аппарат, но и протестировать несколько аппаратов. Специалисты помогли подобрать модель точно под мои потребности. Очень довольна обслуживанием!",
    rating: 4,
    image: "https://avatars.mds.yandex.net/i?id=395704581435156fb11409655ab6e8e1c52fa3a9-5339238-images-thumbs&n=13",
  },
];
