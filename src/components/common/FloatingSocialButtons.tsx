  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 z-50">
        <div className="bg-white rounded-full shadow-lg p-2 flex items-center space-x-1 border border-gray-200">
          <Button
            variant="ghost"
            size="icon"
          ...
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full h-10 w-10 bg-brand hover:bg-brand/90 text-white"
