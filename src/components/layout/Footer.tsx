          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex">
                ...
                <span className="text-muted-foreground">ул. Люблинская д. 100 кор. 2, Москва, Россия</span>
              </li>
              <li className="flex">
                <Phone className="mr-2 h-5 w-5 text-brand" />
                <a href="tel:+74957990926" className="text-muted-foreground hover:text-brand transition">
                  +7 (495) 799-09-26
                </a>
              </li>
              <li className="flex">
